...
export interface VersionedPolimecMainnetApi<Rv extends RpcVersion>
...
/**
 * @name: PolimecMainnetApi
 * @specVersion: 1001001
 **/
export interface PolimecMainnetApi {
  legacy: VersionedPolimecMainnetApi<RpcLegacy>;
  v2: VersionedPolimecMainnetApi<RpcV2>;
}
